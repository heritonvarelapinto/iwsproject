...
<html xmlns="http://www.w3.org/1999/xhtml">
			...
			if(geocoder) {
					...
					function(point) {
	            		if (!point) {
							...
							var html = '<div style=" float: left; padding-right: 0px; font: bold 11px Trebuchet MS, Arial, Helvetica, sans-serif;"><?=$anuncio->getNome();?><br><?=utf8_encode($anuncio->getEndereco())." - ".$anuncio->getNumero();?><br><?=$anuncio->getTelefones();?><\/div>';
  ...
  <body onload="load()" onunload="GUnload()">
    ...
    <? 
    	echo "<img src=\"".$layout->image_path."images/logos/".$anuncio->getLogo()."\">";
