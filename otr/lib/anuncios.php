...
class dsRTE extends dsRTECommand
{
    ...
    public function __construct( $id, $str = false, $resizable = true )
    {
        ...
        $cmds = $str !== false ? $str : 'bold italic underline strikeout | sub sup | left center right | ul ol | indent outdent | color bgcolor  | clean , font fontsize ';
    ...
    public function getHTML( $default_text = '' )
    {
        ...
        $html .= '<tr><td><iframe id="'.$this->id.'" frameborder="0" marginwidth="0" marginheight="0" style="border:0" width="375" height="100"></iframe></td></tr>';
    ...
    private static function buttonFactory( $id, $name )
    {
        switch ( $name )
        {
            ...
            case 'fontsize':
                $button = new dsRTECommandSelect( $id, 'fontsize', '', t( 'Tamanho' ), '1 2 3 4 5' );
                break;
